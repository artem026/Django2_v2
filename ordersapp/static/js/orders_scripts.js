window.onload = function () {
    ...
    /* При подключении скрипта jquery.formset.js в окне редактирования заказа кнопки 
        добавить и удалить продукт срабатывают, но обновления стоимости не происходит!!!
        Код из методички:
